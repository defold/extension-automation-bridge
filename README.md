...
- Dependency-free Python helpers for editor bootstrap, node queries, input gestures, race-free events/state/commands, semantic annotations, timeline markers, waits, screenshots, and diagnostics: [`automation_bridge/automation-bridge-python/`](automation_bridge/automation-bridge-python/README.md)
